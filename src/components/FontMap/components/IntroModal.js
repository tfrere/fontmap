        ...
        <div className="intro-modal" onClick={(e) => e.stopPropagation()}>
          <div className="intro-modal-content">
            ...
            <p className="intro-description">
              This interactive map of more than 1100+ <a href="https://fonts.google.com" target="_blank" rel="noopener noreferrer" className="google-fonts-link">Google Fonts</a> has been organized using machine learning.
            </p>
